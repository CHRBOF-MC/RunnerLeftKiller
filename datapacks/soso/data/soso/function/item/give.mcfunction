...
execute if score shopopen zTEST matches 1 run give @s[team=!build,team=!spc] minecraft:ghast_tear[unbreakable={},custom_name=["",{"text":"商店連線裝置","color":"gold","bold":true}],lore=[["丟出可開啟聊天欄商店"],[{keybind:"key.use"},"可開啟對話框商店"]],custom_data={shopopen:1b,suv:1b},consumable={consume_seconds:9999f,animation:"none"}]
