...
execute if score knono zTEST matches 0 run give @s minecraft:crossbow[can_break={blocks:"minecraft:stripped_acacia_log"},enchantments={"soso:mob/knock":1,"minecraft:quick_charge":1},unbreakable={},custom_name=[{"text":""},{"text":"補師之弩","color":"gold","bold":true}],lore=["別過來！","我..會擊退喔！"],custom_data={suv:1b}]
