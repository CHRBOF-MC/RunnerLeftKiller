...
execute if score knono zTEST matches 0 run tellraw @s [{"text":"近距離武器：擊退I+抗擊退10+15盔甲。","color":"white","bold":true}]
#execute if score knono zTEST matches 0 run tellraw @s [{"text":"遠距離武器：衝擊II。","color":"white","bold":true}]
execute if score knono zTEST matches 0 run tellraw @s [{"text":"血量：60。","color":"white","bold":true}]


execute if score knono zTEST matches 1 run tellraw @s [{"text":"生存者─穩定者","color":"gold","bold":true}]
execute if score knono zTEST matches 1 run tellraw @s [{"text":"近距離武器：抗擊退10+15盔甲。","color":"white","bold":true}]
#execute if score knono zTEST matches 1 run tellraw @s [{"text":"遠距離武器：弓。","color":"white","bold":true}]
execute if score knono zTEST matches 1 run tellraw @s [{"text":"血量：60。","color":"white","bold":true}]
