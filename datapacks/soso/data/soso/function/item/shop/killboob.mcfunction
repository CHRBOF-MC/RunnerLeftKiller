...
execute if score ramdon zTEST matches 3 run give @s minecraft:potion[potion_contents={custom_effects:[{id:"minecraft:jump_boost",amplifier:2,duration:100}]},custom_name=[{"text":""},{"text":"殺手之躍","color":"gold","bold":true}],lore=["怒火爆氣","飛上雲霄。"]]
