...
tellraw @s[scores={shopbuy=0,shop=20},team=Killer] [{"text":"你持有的貨幣已經足夠購買","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 1"}},{"text":"《加速藥水》：","bold":true,"color":"gold","click_event":{"action":"run_command","command":"/trigger shopbuy set 1"}},{"text":"20元，90秒加速II。","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 1"}}]
...
#買東西
scoreboard players set buy shop 0
tellraw @s[scores={shopbuy=0,shop=30},team=Killer] [{"text":"你持有的貨幣已經足夠購買","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 2"}},{"text":"《抗退靴》：","bold":true,"color":"gold","click_event":{"action":"run_command","command":"/trigger shopbuy set 2"}},{"text":"30元，5耐久。","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 2"}}]
...
#買東西
scoreboard players set buy shop 0
tellraw @s[scores={shopbuy=0,shop=50},team=Killer] [{"text":"你持有的貨幣已經足夠購買","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 3"}},{"text":"《殺戮劍》：","bold":true,"color":"gold","click_event":{"action":"run_command","command":"/trigger shopbuy set 3"}},{"text":"50元，鋒利1000，1耐久。","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 3"}}]
...
#買東西
scoreboard players set buy shop 0
tellraw @s[scores={shopbuy=0,shop=50},team=Killer] [{"text":"你持有的貨幣已經足夠購買","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 4"}},{"text":"《殺手之弓》：","bold":true,"color":"gold","click_event":{"action":"run_command","command":"/trigger shopbuy set 4"}},{"text":"50元，附贈箭矢，1耐久。","color":"aqua","click_event":{"action":"run_command","command":"/trigger shopbuy set 4"}}]
