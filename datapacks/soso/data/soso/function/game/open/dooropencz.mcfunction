...
execute if score @s bx = @s posxx unless score @s by = @s posyy at @s run function soso:game/open/dooropency
execute if score @s bx = @s posxx if score @s by = @s posyy unless score @s bz = @s poszz at @s run function soso:game/open/dooropencz
