...
execute unless entity @s[tag=doorclose] at @s as @a[distance=..40] at @s run playsound minecraft:entity.zombie.break_wooden_door block @s ~ ~ ~ 0.7
...
execute at @s[tag=!onb] run function soso:game/kill/dooropencx
execute if score movecopy zTEST matches 1 at @s run function soso:game/kill/dooropendo
