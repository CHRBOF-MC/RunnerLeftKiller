...
execute if entity @s[scores={arrow=0}] run function soso:game/type/stone_button
execute if entity @s[scores={arrow=1}] run function soso:game/type/acacia_button
...
execute if entity @s[scores={arrow=6..11}] run function soso:game/type/plate
