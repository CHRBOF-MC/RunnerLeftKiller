...
execute if score num clear matches 1 run execute if score num clear matches 1 run tellraw @a [{"selector":"@a[scores={clear=0}]","color":"yellow","bold":true},{"text":"遭到處決！","color":"yellow","bold":true}]
