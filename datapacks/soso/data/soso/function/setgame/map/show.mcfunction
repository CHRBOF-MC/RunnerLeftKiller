...
tellraw @a [{"text":"賽道: ","color":"yellow","bold":true},{"score":{"name":"map","objective":"zTEST"},"color":"white","bold":true}," ",{"selector":"@e[tag=mapspawn]","color":"yellow","bold":true},{"selector":"@e[tag=mapspawnkill]","color":"yellow","bold":true}]
