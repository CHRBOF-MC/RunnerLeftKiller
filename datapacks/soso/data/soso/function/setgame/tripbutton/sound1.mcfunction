scoreboard players set @e[limit=1,sort=nearest,tag=buttonbreak,distance=..10] knono 1
title @s actionbar ["",{"text":"陷阱按鈕注目模式：","bold":false,"color":"light_purple"},{"text":"靜音","bold":false,"color":"aqua"}]
