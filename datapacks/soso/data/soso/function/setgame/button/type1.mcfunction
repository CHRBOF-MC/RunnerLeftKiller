scoreboard players remove @e[limit=1,sort=nearest,tag=button,distance=..10] arrow 1
execute if score @e[limit=1,sort=nearest,tag=button,distance=..10] arrow matches -1 run scoreboard players set @e[limit=1,sort=nearest,tag=button,distance=..10] arrow 11
